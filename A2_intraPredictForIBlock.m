function [predicted_block, mode, split_flag] = A2_intraPredictForIBlock(frame, i, j, block_height, block_width, VBSenable, QP, Lambda)
    ...
    [J_horizontal, ~] = A2_computeRD(residual_horizontal, 0, QP, Lambda);
    [J_vertical, ~] = A2_computeRD(residual_vertical, 1, QP, Lambda);
    ...
    if block_height > 2 && block_width > 2
        ...
        for k = 1:4
            ...
            [J_horizontal_sub, ~] = A2_computeRD(residual_horizontal_sub, 0, QP, Lambda);
            [J_vertical_sub, ~] = A2_computeRD(residual_vertical_sub, 1, QP, Lambda);
