function [bestMatch_frame, best_predictedBlk, best_ref_index] = A3_interPredictForPBlock(reference_frames, currentBlock, ...
    ...
    for ref_idx = 1:num_ava_refs
        ...
        for i = 1:size(candidates, 1)
            ...
            if FMEEnable
                referenceBlock = A3_performInterpolation(referenceFrame, mv, refRow, refCol, blockSize);
            end
