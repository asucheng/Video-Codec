function decodedFrame = A3_decodeSplitBlock(referenceFrame, decodedFrame, QTC_Coeff_file, MDiff_file, ...
    ...
    Q_Matrix = A3_generateQMatrix(splitSize, QP); % Pre-compute Q matrix for sub-blocks
