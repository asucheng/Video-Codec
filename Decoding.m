function psnrValues_verify = Decoding(filename_prefix, nframes, blockSize, paddedWidth, paddedHeight, ...
    ...
    for frameIdx = 1:nframes
        ...
        for row = 1:blockSize:paddedHeight
            for col = 1:blockSize:paddedWidth
                ...
                if split_flag == 1
                    ...
                    residualBlock_de = A2_idctAfterDequantizeBlock(residual_block_encoded, Q_Matrix);
        ...
        referenceFrames_de = A2_updateFIFObuffer(referenceFrames_de, nRefFrames, decodedFrame);
