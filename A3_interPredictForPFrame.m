function [predictedFrame, reconstructedFrame, bitConsumedThisFrame, totalRowCounts] = A3_interPredictForPFrame(reference_frames, currentFrame, ...
    ...
    if RCflag
        ...
        for row = 1:blockSize:paddedHeight
            ...
            for col = 1:blockSize:paddedWidth
                ...
                [bestMatch_ns, predictedBlock_ns, best_ref_index_ns] = A3_interPredictForPBlock(reference_frames, ...
                ...
                if VBSEnable
                    ...
                    [J_ns, encoded_block_ns] = A3_computeRD(residualBlock_ns, 0, QPValue, lambda);
                    ...
                    for idx = 1:4
                        ...
                        [sub_mv, sub_pred, sub_ref_idx] = A3_interPredictForPBlock(reference_frames, ...
                        ...
                        [sub_J, sub_encoded] = A3_computeRD(sub_residual, 0, QPValue, lambda);
                    ...
                    if J_split < J_ns
                        ...
                        for idx = 1:4
                            ...
                            bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_mv(1)));
                            bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_mv(2)));
                            bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_ref_index));
                            bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(sub_encoded_blocks{idx});
                            ...
                            sub_residual = A1_Q4_idctAfterDequantizeBlock(sub_decoded, A1_Q4_generateQMatrix(split_size, QPValue));
                        ...
                        [~, encoded_block_ns] = A3_computeRD(residualBlock_ns, 0, QPValue, lambda);
                        fprintf(QTC_stream, '%s\n', encoded_block_ns);
                        bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(encoded_block_ns);
                        ...
                        decoded_residual_ns = A3_idctAfterDequantizeBlock(decoded_block_ns, Q_Matrix);
                    ...
                    % Encode residual block
                    [~, encoded_block_ns] = A3_computeRD(residualBlock, 0, QPValue, lambda);
                    fprintf(QTC_stream, '%s\n', encoded_block_ns);
                    bitConsumedThisRowBlock = bitConsumedThisRowBlock + A3_calcBitCounts(encoded_block_ns);
        ...
        for row = 1:blockSize:paddedHeight
            ...
            for col = 1:blockSize:paddedWidth
                ...
                if VBSEnable
                    ...
                    residualBlock_ns = A1_Q3_calcResidual(predictedBlock_ns, currentBlock, n);
                    [J_ns, encoded_block_ns] = A3_computeRD(residualBlock_ns, 0, QP, lambda);
                    ...
                    for idx = 1:4
                        ...
                        [sub_mv, sub_pred, sub_ref_idx] = A3_interPredictForPBlock(reference_frames, ...
                            ...
                            nRefFrames, FMEEnable, FastME, mv);
                        sub_residual = A1_Q3_calcResidual(sub_pred, sub_block, n);
                        [sub_J, sub_encoded] = A3_computeRD(sub_residual, 0, QP, lambda);
                    ...
                    if J_split < J_ns
                        ...
                        for idx = 1:4
                            ...
                            fprintf(Diff_stream, '%s %s %s\n', A1_Q4_expGolombEncode(diff_mv(1)), A1_Q4_expGolombEncode(diff_mv(2)), A1_Q4_expGolombEncode(diff_ref_index));
                            fprintf(QTC_stream, '%s\n', sub_encoded_blocks{idx});
                            bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_mv(1)));
                            bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_mv(2)));
                            bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(A1_Q4_expGolombEncode(diff_ref_index));
                            bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(sub_encoded_blocks{idx});
                        ...
                        % Encode residual block
                        [~, encoded_block_ns] = A3_computeRD(residualBlock_ns, 0, QP, lambda);
                        fprintf(QTC_stream, '%s\n', encoded_block_ns);
                        bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(encoded_block_ns);
                    ...
                    % Encode residual block
                    [~, encoded_block_ns] = A3_computeRD(residualBlock, 0, QP, lambda);
                    fprintf(QTC_stream, '%s\n', encoded_block_ns);
                    bitConsumedThisFrame = bitConsumedThisFrame + A3_calcBitCounts(encoded_block_ns);
